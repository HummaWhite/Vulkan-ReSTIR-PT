...
PathTracePass::PathTracePass(const zvk::Context* ctx, const zvk::Swapchain* swapchain) : zvk::BaseVkObject(ctx) {
...
void PathTracePass::updateDescriptor(zvk::Image* inImage[2], const zvk::Swapchain* swapchain) {
...
void PathTracePass::createDescriptor(uint32_t nSwapchainImages) {
